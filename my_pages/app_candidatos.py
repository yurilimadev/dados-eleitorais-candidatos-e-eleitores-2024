...
def app_candidatos():
    ...
    st.markdown('# Gráfico de Barras - G')
    ...
    st.markdown('# Gráfico de Barras H - R')
    ...
    st.markdown('# Gráfico de Nuvem de Palavras')
    ...
    st.markdown('# Gráfico de Barras II -Idade')
    ...
    # Adicionando título e subtítulo ao gráfico
    ...
    st.markdown('# Gráfico de Siglas')
    st.pyplot(fig=fig_siglas, use_container_width=True)

    # gráfico folium
    st.markdown('# Gráfico de Mapa')
