...
st.title("Análise de Dados Eleitorais - Nível Municipal 2024")
...
with col1:
    ...
    create_icon_link("images/instagram-round-white.svg",
                     "https://instagram.com/yurilimadev", "Instagram", "Você pode ver minha rotina e o que venho aprendendo na faculdade e aplicando nos stories.")
